...
bins<-read.csv("/Users/elizabeth.chin/Desktop/milk/FL100_lactose_lct_16s/data/CTSC24532USDAWHNRCNu-BinAgeSexBMI_DATA_2022-02-09_1403.csv", header=T)
...
```{r}
dairy<- ffq %>% select(subject_id, d_total, lacs, ffq_qaqc_kcalok:block_ffq_complete)
```

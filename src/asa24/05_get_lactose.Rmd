...
```
```{r}
old<- read.csv("/Users/elizabeth.chin/Desktop/milk/FL100_lactose_lct_16s/data/out_asa24/01_asa24_lactose_dtotal.csv", header=T)
ifelse(round(old$D_TOTAL,2) == round(per.subject$D_TOTAL,2), 1, 0)
```
